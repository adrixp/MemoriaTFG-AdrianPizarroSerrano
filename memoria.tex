...
Cuando arrancamos el proyecto, nuevamente con el comando \textit{start} definido en el fichero \textit{package.json}, se obtiene como resultado la Figura~\ref{fig:iteracion2-resultado} y la Figura~\ref{fig:iteracion2-resultadob}.
\begin{figure}
	\centering
