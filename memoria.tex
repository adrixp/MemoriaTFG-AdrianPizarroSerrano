...
En esta fase previa se comienza realizando un estudio previo de las tecnologías que vamos a utilizar en el proyecto. Se comienza visitando la web oficial de A-Frame\footnote{\url{https://aframe.io/}} donde podemos encontrar toda la documentación\footnote{\url{https://aframe.io/docs/0.9.0/introduction/}} necesaria para comenzar a crear escenas en 3D en nuestro navegador con unos simples pasos. Además, vamos a proceder a nuestra iniciación en el mundo con proyectos NodeJs y Webpack. Para todos estas tecnologías, el tutor de esta memoria ha proporcionado una web\footnote{\url{https://jgbarah.github.io/aframe-playground/}} con documentación y ejemplos que también han ayudado en el estudio previo a realizar.



 

Fase previa para comenzar el proyecto. Estudio de A-frame js, Webpack, nodejs etc. Todo el playground aframe de Jesús.

\section{Iteración 1. Primer gráfico.} 
\label{sec:iteracion_1}
-Reproducción de primeras escenas con A-frame. 

-Primera creación de repositorio llamado A-Charts. Creación de 2 ramas para el proyecto. Develop y Master

\section{Iteración 2. Enriquecimiento de la librería y separación de la capa de datos.} 
\label{sec:iteracion_2}

-Creación de primeros gráficos de barras.

- Creación de gráfico de líneas

- Librería como plugin.

-Creación de gráfico de burbujas

-Licencia Apache

- Json de Datos, Formato!

-Comenzamos a separar la librería de la capa de datos pudiendo leer de un JSON
