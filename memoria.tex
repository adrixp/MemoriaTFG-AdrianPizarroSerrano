...
Primero se muestra el template html

Después enseñamos el código de un componente y se comenta que todos son iguales.
Aqui ademas se dice que cada gráfico rellena su componente axis y que este ha sido refactorizo


Por último se habla un poco del selector de gráfos. Su html y un poco de su código y Si eso un poco de la nueva configuracion con el css de webpack
...
Todo ello gracias a la función \textit{update} de A-Frame.
\clearpage
