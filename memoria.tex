...
\lstinputlisting[language=Html]{code/iteracion1-template.html}

Por otra parte nuestro código JavaScript

\lstinputlisting[language=JavaScript, title= code 1]{code/iteracion1-import.js}

\lstinputlisting[language=JavaScript]{code/iteracion1-loader.js}
...
Cuando se arranca el proyecto se obtiene como resultado el primer gráfico que se puede ver en la Figura~\ref{fig:iteracion1-resultado} 
