...
WebGL 2.0 está basado en OpenGL 3.0 y garantiza disponibilidad de muchas extensiones opcionales de WebGL 1.0 y presenta nuevas APIs.?

WebGL está integrado completamente en todos los estándares web del navegador, permitiendo la aceleración de la GPU y el procesamiento de imágenes y efectos.
Esta gestión de memoria automática se proporciona mediante el lenguaje JavaScript.
...
En la  Figura~\ref{fig:threejscene}


\begin{figure}
	\centering
	\includegraphics[width=12cm, keepaspectratio]{img/threejscene}
