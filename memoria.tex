...
Por tanto se puede decir que el objetivo de esta librería sería,  mediante estas entidades generícas, dotar de a nuestro HTML de los gráficos que se requieran.

Como se puede ver, la etiqueta \textless a-entity\textgreater tiene un identificador que utilizaremos en el código JavaScript detallado a continuación para generar un componente llamado \textit{axis}, el cual representará los ejes x,y,z en 3D.
...
A continuación se define la función encargada de generar el gráfico 
\lstinputlisting[language=JavaScript, title= Función ejecutada al cargarse el DOM]{code/iteracion1-loader.js}

\lstinputlisting[language=JavaScript]{code/iteracion1-barplot.js}

\lstinputlisting[language=JavaScript]{code/iteracion1-axis.js}
