...
Por otra parte y de manera más específica, se ha logrado concluir con éxito varios de los objetivos previstos. Se ha conseguido proporcionar distintos tipos de visualizaciones básicas en tres dimensiones. También se ha dotado de gran versatilidad al usuario a la hora de configurar los ejes o gráficos gracias a la gran cantidad de parámetros proporcionados.
