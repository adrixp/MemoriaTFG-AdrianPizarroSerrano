...
Por tanto, se decide implementar este nuevo tipo de gráfico en la librería. Además, visto que tanto el gráfico de tartas y el gráfico con forma de donut siguen un desarrollo muy parecido se deciden añadir ambos.
