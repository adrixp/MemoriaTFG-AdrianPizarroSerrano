...
Hablamos de la metodología Scrum y de las distintas iteraciones con breve descripción de la misma

\subsection{Iteración 0} 
\label{sec:iteracion_0}

Fase previa para comenzar el proyecto. Estudio de A-frame js, Webpack, nodejs etc.

\subsection{Iteración 1} 
\label{sec:iteracion_1}
-Reproducción de primeras escenas con A-frame. Estudio de A-frame playgruund de Jesús.
...
-Texto de los ejes, color y tamaño del mismo

-Se añade gráficos de cilindros

-Se añaden los gráficos de tarta y donut
