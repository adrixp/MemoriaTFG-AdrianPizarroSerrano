...
La visualización y explotación de datos como motivación

Hasta ahora no hay un uso extendido de librerias en 3D tanto en aframe como fuera de ello. Un nicho por explotar

Me dedico a la parte de explotación y visualización de datos.

despues de un intento fallido pude volver a retomar mi trabajo y terminar esta libreria
