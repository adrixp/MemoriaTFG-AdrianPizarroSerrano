...
A mis amigos de toda la vida y a mis compañeros de carrera los cuales habéis comenzado a ser parte de mi vida. Gracias por todas las buenas experiencias y recuerdos que siempre me llevaré. Por supuesto, sin vuestro apoyo y compañerismo hubiera sido un camino totalmente distinto y arduo de recorrer.

Gracias a mi tutor Jesús M. González Barahona al cual llegué después de abandonar otro proyecto y me acogió con los brazos abiertos. Siempre teniendo disponibilidad y prestándome ayuda cuando lo necesitaba.
...
Este proyecto consiste en la creación de una librería capaz de representar datos en tres dimensiones. La finalidad es publicar esta librería para que el resto de desarrolladores pueda utilizarla y contribuir a su mejora continua. Por ello, uno de los objetivos que se persigue es que sea escalable, mantenible y sencilla de utilizar.

Para este menester, se ha contado con la inestimable ayuda del \textit{framework} de A-Frame. El cual, nos permite construir experiencias de realidad virtual en el navegador. Gracias a todas las estructuras básicas y el API extenso que nos provee se ha podido desarrollar con éxito esta librería. Como se explica en esta memoria, se apoya fundamentalmente en la librería ThreeJs cuyo motor gráfico es WebGL.

Una de las motivaciones principales es el auge del tratamiento de datos y explotación de la información, así como las nuevas tecnologías de realidad virtual. Por tanto, gracias a la creciente necesidad de analizar grandes cantidades de información sumado al impacto de tecnologías 3D, hacen de este trabajo un proyecto apasionante.
...
This project consists on the creation of a library able of representing data in three dimensions. The purpose is to publish this library in order to other developers can use it and contribute to its continuous improvement. Therefore, one of the objectives pursued is that must be scalable, maintainable and simple to use.

For this reason, I have had the invaluable help of the A-Frame framework. Which allows to build virtual reality experiences in the browser. Thanks to all the basic structures and the extensive API that it provides, this library has been successfully developed. As explained in this report, it is fundamentally based on the ThreeJs library whose graphic engine is WebGL.

One of the main motivations is the rise of data processing and information exploitation, as well as new virtual reality technologies. Therefore, thanks to the growing need to analyze large amounts of information added to the impact of 3D technologies, makes this work an exciting project.
...
Este proyecto consiste en crear un sistema para la visualización de datos en 3D compatible con cualquier navegador. La cual además pueda ser usada en un dispositivo de realidad virtual.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=16cm, keepaspectratio]{img/iteracion4-result}
	\caption{Iteración 4: Resultado}
	\label{fig:iteracion4-result}
\end{figure}
\clearpage

\section{Iteración 5. Leyenda y pop-up, consumo de otras fuentes de datos y Adaptación para dispositivos de VR.} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm, keepaspectratio]{img/iteracion5-popup}
	\caption{Iteración 5: Resultado Pop-up}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=8cm, keepaspectratio]{img/iteracion5-legend}
	\caption{Iteración 5: Resultado Pop-up}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=7cm]{img/resultados-burbujas}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=7cm]{img/resultados-barras}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=7cm]{img/resultados-cilinder}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6cm]{img/resultados-pie}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6cm]{img/resultados-doughnut}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{img/resultados-totem}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{img/resultados-axis-param}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=7cm]{img/resultados-pop-up}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{img/resultados-legend}
